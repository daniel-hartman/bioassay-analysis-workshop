...
```
    ...
    ## 3     11 negative.control dos                  25 dead.hr.72       0
...
We have our mortality calculated - great. I don’t like how `Time Point`
...
Finally, `fact_grid()` splits up our data across multiple ‘facets’ (in
